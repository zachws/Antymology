...
namespace Antymology.Helpers
{
    public class SimplexNoise
    {
        ...
        private Vector4[] grad3 = new Vector4[] {
            new Vector4(1,1,0), new Vector4(-1,1,0), new Vector4(1,-1,0), new Vector4(-1,-1,0),
            new Vector4(1,0,1), new Vector4(-1,0,1), new Vector4(1,0,-1), new Vector4(-1,0,-1),
            new Vector4(0,1,1), new Vector4(0,-1,1), new Vector4(0,1,-1), new Vector4(0,-1,-1)
        };
        ...
        public float GetNoise(double xin, double yin, double zin)
        {
            ...
            int i = CustomMath.fastfloor(xin + s);
            int j = CustomMath.fastfloor(yin + s);
            int k = CustomMath.fastfloor(zin + s);
            double t = (i + j + k) * G3;
            ...
            {
                t0 *= t0;
                n0 = t0 * t0 * CustomMath.dot(grad3[gi0], x0, y0, z0);
            }
            ...
            {
                t1 *= t1;
                n1 = t1 * t1 * CustomMath.dot(grad3[gi1], x1, y1, z1);
            }
            ...
            {
                t2 *= t2;
                n2 = t2 * t2 * CustomMath.dot(grad3[gi2], x2, y2, z2);
            }
            ...
            {
                t3 *= t3;
                n3 = t3 * t3 * CustomMath.dot(grad3[gi3], x3, y3, z3);
            }
        ...
        /// <summary>
        /// Generates a new permutation value which acts as a seed
        /// </summary>
